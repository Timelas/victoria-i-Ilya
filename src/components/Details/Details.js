...
function Details() {
  return (
    <section className="details" id="details">
      ...
      <p className="details__text">Детали: Пожалуйста, подтвердите ваше присутствие на нашем празднике до  1 августа 2023 года лично или телефонным звонком /любым удобным для вас способом.</p>
